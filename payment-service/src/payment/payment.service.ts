...
import {PaymentOrder,PaymentEvent,Prisma } from "../../generated/prisma/client";
...
export class PaymentService {
    ...
    updatePaymentOrder(where: Prisma.PaymentOrderWhereUniqueInput, data: Prisma.PaymentOrderUpdateInput):Promise<PaymentOrder>
    {
        return this.prisma.paymentOrder.update({where, data})
    }

    async createPaymentIntent(paymentOrder: PaymentOrderDto){
        const order = await this.stripeService.createPaymentIntent( Number(paymentOrder.amount), 
